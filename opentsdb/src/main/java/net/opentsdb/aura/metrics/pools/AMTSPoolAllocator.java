...
import net.opentsdb.aura.metrics.storage.AuraMetricsTimeSeries;
...
public class AMTSPoolAllocator extends BaseObjectPoolAllocator {
  public static final String TYPE = "AMTSPool";
  private static final TypeToken<?> TYPE_TOKEN = TypeToken.of(
      AuraMetricsTimeSeries.class);
  
  @Override
  public Object allocate() {
    return new AuraMetricsTimeSeries();
  }
