...
public class AuraMetricsSourceFactory extends BaseTSDBPlugin 
    implements TimeSeriesDataSourceFactory<TimeSeriesDataSourceConfig, AuraMetricsQueryNode> {
    private static final Logger LOGGER  = LoggerFactory.getLogger(AuraMetricsSourceFactory.class);
    public static final String TYPE = "AuraMetrics";
  ...
  @Override
    ...
    @Override
    public AuraMetricsQueryNode newNode(QueryPipelineContext context) {
      throw new UnsupportedOperationException();
    }

    @Override
    public AuraMetricsQueryNode newNode(final QueryPipelineContext context,
                                        final TimeSeriesDataSourceConfig config) {
      return new AuraMetricsQueryNode(this, context, config, rollupConfig, timeSeriesStorage, timeSeriesRecordFactory.create(), queryIncludesNamespace);
    }
