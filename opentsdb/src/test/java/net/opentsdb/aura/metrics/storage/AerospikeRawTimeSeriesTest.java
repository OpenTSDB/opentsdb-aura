...
public class AerospikeRawTimeSeriesTest {
  ...
  public void fullSegments() throws Exception {
    ...
    when(records.hasNext())
            ...
            .thenReturn(true)
            .thenReturn(false);
    RawTimeSeriesEncoder enc1 = mockEncoder(1614556800);
    RawTimeSeriesEncoder enc2 = mockEncoder(1614556800 + (3600 * 2));
    RawTimeSeriesEncoder enc3 = mockEncoder(1614556800 + (3600 * 4));
    when(records.next())
            .thenReturn(enc1)
            .thenReturn(enc2)
            .thenReturn(enc3);
  ...
  RawTimeSeriesEncoder mockEncoder(int segmentTime) {
